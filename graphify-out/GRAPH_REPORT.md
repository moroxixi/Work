...
## Corpus Check
- 37 files · ~49,799 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 612 nodes · 813 edges · 39 communities (33 shown, 6 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c67260bd`
...
Cohesion: 0.08
Nodes (16): backBtn, btnLoading, btnText, cardDomisili, cardKode, cardNama, cardSection, cardTanggal (+8 more)

### Community 36 - "code.gs.js"
Cohesion: 0.35
Nodes (12): doGet(), doGetFormData_(), doPost(), doPostPendaftaran_(), doPostSubmitOrder_(), generateKodeMembership_(), getMemberSheet_(), getOrCreateFolder_() (+4 more)

### Community 37 - "Submit/script.js"
Cohesion: 0.06
Nodes (31): base64ToBlob(), btnLoading, btnText, downloadLaporanBtn, errorMsg, escapeHtml(), formatStampFile(), formatWaktu() (+23 more)

## Knowledge Gaps
- **286 isolated node(s):** `all`, `menuBtn`, `drawer`, `overlay`, `drawerClose` (+281 more)
