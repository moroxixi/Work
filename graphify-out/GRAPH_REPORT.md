...
## Corpus Check
- 37 files · ~50,149 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 614 nodes · 816 edges · 39 communities (33 shown, 6 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `803f7a5e`
...
## Knowledge Gaps
- **287 isolated node(s):** `all`, `menuBtn`, `drawer`, `overlay`, `drawerClose` (+282 more)
